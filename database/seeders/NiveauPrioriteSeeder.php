...
class NiveauPrioriteSeeder extends Seeder
{
    ...
    public function run()
    {
        $niveau_priorites = [
            ...
            ['name' => 'P1', 'ies' => '1 à 10', 'action' => "Si pertinent et économiquement acceptable, des mesures peuvent être proposées à la direction pour améliorer la situation environnementale liée à cet Aspect/impact avec une surveillance"]
        ];
